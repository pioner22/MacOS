#!/bin/bash
# BigSurVPN 2.1.3. One command: download -> configure -> launch -> verify -> speed.
...
bigsur_vpn_bootstrap() (
  ...
  umask 077
  local runtime_ref=dd2919e5578010917ebc134e8f99a5f56b6263d6
  local runtime_sha=762b5fe24042a78944d9231653106899c2befe35c541fbc07feb9337f3226061
