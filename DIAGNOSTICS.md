# Mac Hardware Diagnostics — 2.0.0-rc8 / Bootstrap 1.4
...
[Исправление тайм-аутов rc8](docs/diagnostics/RC8_PROBE_TIMEOUT_RU.md) · [Проверки rc8](docs/diagnostics/RC8_QA.md) · [Реестр и ограничения](docs/diagnostics/RC7_REGISTRY_RU.md) · [Read-only режим](docs/diagnostics/RC6_READONLY_HDD.md)

## English

The stable launcher selects one verified release. Live facts and capability probes feed the integrated registry before the menu. Option 21 records compatibility only; 14 checks software; 15 edits the profile and returns to the menu. One test/suite selection ends in a report and exit. No new heavy workload, automatic upload or destructive RAW mode is enabled. Native Recovery binary distribution and actual Mac validation remain pending. [rc8 probe timeout fix](docs/diagnostics/RC8_PROBE_TIMEOUT_EN.md) · [Registry](docs/diagnostics/RC7_REGISTRY_EN.md) · [Validation](docs/diagnostics/RC8_QA.md).
