...
diag_entry(){
  ...
  curl -q -fsSL --retry 0 --proto '=https' --proto-redir '=https' --max-redirs 5 --connect-timeout 15 --max-time 120 --max-filesize 1048576 \
    'https://raw.githubusercontent.com/pioner22/MacOS/069c6d7feafa8eff75696d38b0818eb43fbe9ec5/st.sh' -o "$tmp" || return 3
  ...
  [ "${got%% *}" = d398ff4d25756f279b78909ddec2bc005727b7a17e7a84c11d06fffd29857836 ] || { echo 'RESULT=INCONCLUSIVE BOOTSTRAP_HASH_FAILED';return 3; }
