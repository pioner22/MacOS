...
diag_entry(){
  ...
  curl -q -fsSL --retry 0 --proto '=https' --proto-redir '=https' --max-redirs 5 --connect-timeout 15 --max-time 120 --max-filesize 1048576 \
    'https://raw.githubusercontent.com/pioner22/MacOS/da6537e4fa8cb81291f9057d5ab6d268432f9f0e/st.sh' -o "$tmp" || return 3
  ...
  [ "${got%% *}" = cacc7d3d5841a060e8c17faba0a5f0902d3f4062611237c928d5876753eb092e ] || { echo 'RESULT=INCONCLUSIVE BOOTSTRAP_HASH_FAILED';return 3; }
